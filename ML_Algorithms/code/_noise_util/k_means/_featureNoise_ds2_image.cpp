...
{ 
    ...
    for(int ii = 1; ii<=5; ii++)
    {
        ...
        string input2 = "image.txt";
        string ds_clases = 
        "C:/Users/Swastik/Desktop/MastersDegree_CS/Semester_1/MachineLearning/GroupAssingment/noisyDataSets/ML_Algorithms/data_set/k_means/ds_2/" + input1;
        string ns_ds1 = 
        "C:/Users/Swastik/Desktop/MastersDegree_CS/Semester_1/MachineLearning/GroupAssingment/noisyDataSets/ML_Algorithms/data_set/k_means/ds_2/ds_"
        + to_string(ii+base) + "/";
        string desc_file = ns_ds1 + "description.txt";
     
        string str = "";
        int lineNumber = 0;
        float NOISE_SIZE = 0.1f * ii;
        int MIN_NOISE_PERCENT = noiseSeed;
        int NOISE_PERCENT = noiseSeed+10;
        ...
        // cout<<data<<endl;
        std::ofstream out(ns_ds1 + input2);
        out << data;
        out.close();
